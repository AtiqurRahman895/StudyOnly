...
const UploadMaterialsModal = ({session_id, tutor_email}) => {
    ...
    const handleSubmit=async(e)=>{
        ...
        const materialCredentials={session_id,tutor_email,title,image,material_link}
        try {
            ...
            toast.error(
              "Failed to add this material!"
            );
        }
    }
    return (
        <>
            <button className="primaryButton activePrimaryButton !py-2.5 " onClick={()=>setOpenModal(true)}>Upload material</button>
            <dialog id="material_modal" className="modal bg-[rgba(0,0,0,.4)]" open={openModal}>
                <div className="modal-box bg-black">
                    ...
                    <form onSubmit={handleSubmit} className="space-y-4 pt-6">
                        ...
                        <TitleInputSection title={title} setTitle={setTitle} forModal={true} />
                        <MaterialLinkInputSection material_link={material_link} setMaterial_link={setMaterial_link} />
