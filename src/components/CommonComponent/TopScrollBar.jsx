...
const TopScrollBar = ({ blogCount }) => {
  ...
  const [categoryList, setCategoryList] = useState([ "All", "Maintenance", "Repairs", "DIY", "Seasonal", "Technology", "Stories",]);

  useEffect(()=>{

      const allCategoryList=["All", "Maintenance", "Repairs", "DIY", "Seasonal", "Technology", "Stories",]
