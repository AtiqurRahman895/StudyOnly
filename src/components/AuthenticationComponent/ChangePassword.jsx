        ...
        <section className="mt-16">
            <div className="container hero flex items-center justify-center">
                    ...
                    <form onSubmit={CreatUserOnSubmit} className="card-body p-0">
                        ...
                        <input type="email" name="email" id="email"className="input input-ghost input-bordered disabled:border  disabled:border-gray-300" value={user.email} disabled/>
                        </div>
                        ...
                        <div className="form-control relative">
                            ...
                            {passwordError && 
                                <label htmlFor="password" className="label">
                                    <p className=" text-red-500">Password must Be 6 to 20 characters long, Include at least one digit (0-9), one lowercase letter (a-z), one uppercase letter (A-Z) and one special character (@#$%^&*!)</p>
                                </label>
                            }
                        </div>
