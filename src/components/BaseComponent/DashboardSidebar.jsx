    ...
    return (
        <section>
            ...
            <div className="container drawer lg:drawer-open lg:gap-4">
                <input id="DashboardNavSideBar" type="checkbox" className="drawer-toggle" />
                <div className="drawer-content">
                    <Outlet />
                </div>
                <div className="drawer-side z-50 lg:bg-custom-primary rounded-md lg:py-20">
                    <label htmlFor="DashboardNavSideBar" aria-label="close sidebar" className="drawer-overlay"></label>
